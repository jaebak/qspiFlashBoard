...
namespace Mt25Flash {
  ...
  bool readDataBytesCommand(FT_HANDLE ftHandle, uint32 address, unsigned char * pData , uint16 size)
  {
    uint16 sizeTransferred;
    FT4222_STATUS ftStatus;
    std::vector<unsigned char> writeBuffer;
  ...
  bool fastQuadReadCommand(FT_HANDLE ftHandle, uint32 address, unsigned char * pData , uint16 size, int nDummy=4)
  {
